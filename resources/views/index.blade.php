...
@section('content')
    @if (! Auth::check())
        ...
        <p>The promise of Prego is simple. All your projects an todos on one screen without having to filter by team or users. Finally, project management built just for humanbeings. Very Intuitve, Slick and crafted with the power of Laravel</p>

        <p><img src="{{'images/projectmanagement.gif'}}" /></p>
 -->
